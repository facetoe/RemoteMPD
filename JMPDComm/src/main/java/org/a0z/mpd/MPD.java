...
public class MPD {
    ...
    protected AbstractMPDConnection mpdConnection;
     ...
     */
    public AbstractMPDConnection getMpdConnection() {
    ...
    public void adjustVolume(int modifier) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_SET_VOLUME, Integer.toString(vol));
    }
    ...
    public void disconnect() throws MPDServerException {
        ...
        if (mpdConnection != null && mpdConnection.isConnected()) {
            try {
                getMpdConnection().sendCommand(MPDCommand.MPD_CMD_CLOSE);
    ...
    protected List<Music> genericSearch(String searchCommand, String type, String strToFind) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(searchCommand, type, strToFind);
    ...
    protected List<Music> genericSearch(String searchCommand, String args[], boolean sort) throws MPDServerException {
        ...
        return Music.getMusicFromList(getMpdConnection().sendCommand(searchCommand, args), sort);
    }
    ...
    public List<FilesystemTreeEntry> getDir(String path) throws MPDServerException {
        ...
        List<String> resonse = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LSDIR, path);
    ...
    public String getMpdVersion() throws MPDServerException {
        ...
        if (mpdConnection instanceof BluetoothMPDConnection) {
            version = mpdConnection.getMpdVersion();
        } else {
            version = mpdIdleConnection.getMpdVersion();
        }
    ...
    public MPDStatistics getStatistics() throws MPDServerException {
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_STATISTICS);
    ...
    public MPDStatus getStatus(boolean forceRefresh) throws MPDServerException {
        if (forceRefresh || mpdStatus == null || mpdStatus.getState() == null) {
            ...
            if (mpdConnection instanceof BluetoothMPDConnection) {
                response = getMpdConnection().sendCommand(new BTServerCommand(BTServerCommand.MPD_CMD_STATUS));
            } else {
                response = mpdStatusConnection.sendCommand(MPDCommand.MPD_CMD_STATUS);
            }
    ...
    public Directory listAllFiles(String dir) throws MPDServerException {
      ...
      List<String> list = getMpdConnection().sendCommand(MPD_CMD_LISTALL, dir);
    ...
    */
    ...
    public List<String> listGenres(boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_GENRE);
    ...
    public List<String> listArtists(boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ARTIST);
    ...
    public List<String> listArtists(String genre, boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ARTIST, MPDCommand.MPD_TAG_GENRE, genre);
    ...
    public List<String> listAlbumArtists(boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ALBUM_ARTIST);
    ...
    public List<String> listAlbumArtists(Genre genre, boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ALBUM_ARTIST, MPDCommand.MPD_TAG_GENRE,
                genre.getName());
    ...
    public void next() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_NEXT);
    }
    ...
    public void pause() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PAUSE);
    }
    ...
    public void play() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PLAY);
    }
    ...
    public void previous() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PREV);
    }
    ...
    public void refreshDatabase() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_REFRESH);
    }

    /**
     * Similar to <code>find</code>,<code>search</code> looks for partial matches in the MPD database.
     *
     * @param type   type of search. Should be one of the following constants: MPD_SEARCH_ARTIST, MPD_SEARCH_TITLE, MPD_SEARCH_ALBUM,
     *               MPD_SEARCG_FILENAME
     * @param string case-insensitive locator string. Anything that contains <code>string</code> will be returned in the results.
     * @return a Collection of <code>Music</code>.
     * @throws MPDServerException if an error occur while contacting server.
     * @see org.a0z.mpd.Music
     */
    ...
    public void seekById(int songId, long position) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_SEEK_ID, Integer.toString(songId), Long.toString(position));
    }
    ...
    public void seekByIndex(int index, long position) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_SEEK, Integer.toString(index), Long.toString(position));
    }
    ...
    public void setRandom(boolean random) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_RANDOM, random ? "1" : "0");
    }
    ...
    public void setRepeat(boolean repeat) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_REPEAT, repeat ? "1" : "0");
    }
    ...
    public void setSingle(boolean single) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_SINGLE, single ? "1" : "0");
    }

    /**
     * Enabled or disable consuming.
     *
     * @param consume if true song consuming will be enabled, if false song consuming will be disabled.
     * @throws MPDServerException if an error occur while contacting server.
     */
    public void setConsume(boolean consume) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_CONSUME, consume ? "1" : "0");
    }
    ...
    public void shutdown() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_KILL);
    }
    ...
    public void skipToPositon(int position) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PLAY, Integer.toString(position));
    }
    ...
    public void skipToId(int id) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_PLAY_ID, Integer.toString(id));
    }
    ...
    public void stop() throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_STOP);
    }
    ...
    public void setCrossfade(int time) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_CROSSFADE, Integer.toString(Math.max(0, time)));
    }
    ...
    public List<MPDOutput> getOutputs() throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_OUTPUTS);
    ...
    public List<Item> getPlaylists(boolean sort) throws MPDServerException {
        ...
        List<String> response = getMpdConnection().sendCommand(MPDCommand.MPD_CMD_LISTPLAYLISTS);
        for (String line : response) {
            if (line.startsWith("playlist"))
    ...
    public void enableOutput(int id) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_OUTPUTENABLE, Integer.toString(id));
    }
    ...
    public void disableOutput(int id) throws MPDServerException {
        ...
        getMpdConnection().sendCommand(MPDCommand.MPD_CMD_OUTPUTDISABLE, Integer.toString(id));
    }
     ...
     *
     * @param runnable The runnable that will be responsible of inserting the songs into the queue
