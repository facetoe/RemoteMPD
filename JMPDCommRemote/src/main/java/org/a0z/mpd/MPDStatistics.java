...
public class MPDStatistics {
	...
	/**
	 * Retrieves the amount of time mpd would take to play every song in the db once.
	 * 
	 * @return Retrieves the amount of time (in seconds) mpd would take to play every song in the db once.
	 */
