...
public abstract class AbstractMPDManager extends MPD {
     ...
     * @param command
     */
    abstract List<String> sendCommand(String command);

    abstract List<String> sendCommand(AbstractCommand command);

    abstract List<String> sendCommand(String command, String... args);

    abstract List<String[]> sendCommandQueueSeparated();
    ...
    public void adjustVolume(int modifier) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_SET_VOLUME, Integer.toString(vol));
    }
    ...
    public void clearError() throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_CLEARERROR);
    }
    ...
    protected List<Music> genericSearch(String searchCommand, String type, String strToFind) throws MPDServerException {
        ...
        List<String> response = sendCommand(searchCommand, type, strToFind);
    ...
    protected List<Music> genericSearch(String searchCommand, String args[], boolean sort) throws MPDServerException {
        ...
        return Music.getMusicFromList(sendCommand(searchCommand, args), sort);
    }
    ...
    public List<FilesystemTreeEntry> getDir(String path) throws MPDServerException {
        ...
        List<String> resonse = sendCommand(MPDCommand.MPD_CMD_LSDIR, path);
    ...
    public MPDStatistics getStatistics() throws MPDServerException {
        List<String> response = sendCommand(MPDCommand.MPD_CMD_STATISTICS);
    ...
    protected void getAlbumDetails(List<Album> albums,
        ...
        List<String[]> response = sendCommandQueueSeparated();
    ...
    public Directory listAllFiles(String dir) throws MPDServerException {
      ...
      List<String> list = sendCommand(MPD_CMD_LISTALL, dir);
    ...
    */
    ...
    public List<String> listGenres(boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_GENRE);
    ...
    public List<String[]> listArtists(List<Album> albums, boolean albumArtist) throws MPDServerException {
        ...
        List<String[]> responses = sendCommandQueueSeparated();
    ...
    public List<String> listArtists(boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ARTIST);
    ...
    public List<String> listArtists(String genre, boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ARTIST, MPDCommand.MPD_TAG_GENRE, genre);
    ...
    public List<String> listAlbumArtists(boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ALBUM_ARTIST);
    ...
    public List<String> listAlbumArtists(Genre genre, boolean sortInsensitive) throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_LIST_TAG, MPDCommand.MPD_TAG_ALBUM_ARTIST, MPDCommand.MPD_TAG_GENRE,
                genre.getName());
    ...
    public void refreshDatabase() throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_REFRESH);
    }
    ...
    public void seekById(int songId, long position) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_SEEK_ID, Integer.toString(songId), Long.toString(position));
    }
    ...
    public void seekByIndex(int index, long position) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_SEEK, Integer.toString(index), Long.toString(position));
    }
    ...
    public void setRandom(boolean random) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_RANDOM, random ? "1" : "0");
    }
    ...
    public void setRepeat(boolean repeat) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_REPEAT, repeat ? "1" : "0");
    }
    ...
    public void setSingle(boolean single) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_SINGLE, single ? "1" : "0");
    }
    ...
    public void setConsume(boolean consume) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_CONSUME, consume ? "1" : "0");
    }
    ...
    public void shutdown() throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_KILL);
    }
    ...
    public void skipToPositon(int position) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_PLAY, Integer.toString(position));
    }
    ...
    public void skipToId(int id) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_PLAY_ID, Integer.toString(id));
    }
    ...
    public List<MPDOutput> getOutputs() throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_OUTPUTS);
    ...
    public List<Item> getPlaylists(boolean sort) throws MPDServerException {
        ...
        List<String> response = sendCommand(MPDCommand.MPD_CMD_LISTPLAYLISTS);
        for (String line : response) {
            if (line.startsWith("playlist"))
    ...
    public void enableOutput(int id) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_OUTPUTENABLE, Integer.toString(id));
    }
    ...
    public void disableOutput(int id) throws MPDServerException {
        ...
        sendCommand(MPDCommand.MPD_CMD_OUTPUTDISABLE, Integer.toString(id));
    }
