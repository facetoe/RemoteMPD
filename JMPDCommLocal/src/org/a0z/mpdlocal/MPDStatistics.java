...
public class MPDStatistics {
	...
	/**
	 * Retrieves time mpdlocal has been playing music.
	 * 
	 * @return how long mpdlocal has been actually playing music in seconds.
	 */
	...
	/**
	 * Retrieves the amount of time mpdlocal would take to play every song in the db once.
	 * 
	 * @return Retrieves the amount of time (in seconds) mpdlocal would take to play every song in the db once.
	 */
	...
	public String toString() {
		return "artists: " + this.artists + " albums: " + this.albums + " songs: " + this.songs + " uptime: " + this.uptime
