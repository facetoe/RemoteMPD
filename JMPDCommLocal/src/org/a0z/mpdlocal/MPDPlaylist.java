...
import org.a0z.mpdlocal.event.AbstractStatusChangeListener;
...
public class MPDPlaylist extends AbstractStatusChangeListener {
	 ...
	 * @see org.a0z.mpdlocal.event.AbstractStatusChangeListener#playlistChanged(org.a0z.mpdlocal.MPDStatus, int)
	 */
	@Override
	...
	public void removeAlbumById(int songId) throws MPDServerException {
            ...
            if (artist == null || album == null)
                return;
            if (DEBUG)
                System.out.println("Remove album "+ album + " of "+artist);
            ...
            if (DEBUG)
                System.out.println("Removed "+num + " songs");
            this.mpd.getMpdConnection().sendCommandQueue();
	}
