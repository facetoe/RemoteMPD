...
public class MPDCommand {
    ...
    public static final String MPD_CMD_PLAYLIST_INFO_TEST = "playlistinfo";
    ...
    public String toString() {
        ...
        if (DEBUG)
            System.out.println("Mpd command : " + (outString.startsWith("password ") ? "password **censored**" : outString));
        return outString;
    }
